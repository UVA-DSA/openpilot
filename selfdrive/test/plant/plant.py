...
class Plant(object):
  ...
  def step(self, reportHazardH1, reportHazardH2, reportHazardH3, outfile, hazardfile, v_lead=0.0, cruise_buttons=None, grade=0.0, frameIdx=0, pathOffset=0.0, lLane=0.0, rLane=0.0, delta_lane=0.0, publish_model = True):     # outfile, hazardfile, frameIdx and pathOffset added by Hasnat
    ...
    self.rk.keep_time()
    return (distance, speed, acceleration, distance_lead, brake, gas, steer_torque, live_msgs, self.angle_steer, reportHazardH1, reportHazardH2, reportHazardH3)   # added self.angle_steer -- Hasnat
